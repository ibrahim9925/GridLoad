...
-- 2. Drop existing warranty policies and recreate with stricter access
DROP POLICY IF EXISTS "Authorized staff can view warranties" ON public.warranties;
DROP POLICY IF EXISTS "Authorized staff can manage warranties" ON public.warranties;
DROP POLICY IF EXISTS "Sales and warehouse staff can manage warranties" ON public.warranties;
DROP POLICY IF EXISTS "Staff can view warranties" ON public.warranties;
DROP POLICY IF EXISTS "Authorized staff can create warranties" ON public.warranties;
DROP POLICY IF EXISTS "Authorized staff can update warranties" ON public.warranties;

-- Create stricter warranty policies
CREATE POLICY "Restricted warranty access"
...
-- Fix warranty claims access - remove all existing policies
DROP POLICY IF EXISTS "Authorized staff can view warranty claims" ON public.warranty_claims;
DROP POLICY IF EXISTS "Authorized staff can manage warranty claims" ON public.warranty_claims;
...
CREATE POLICY "Restricted warranty claims access"
...
-- Drop existing policies for site_settings if they exist
DROP POLICY IF EXISTS "Admins can manage site settings" ON public.site_settings;
DROP POLICY IF EXISTS "Public settings are viewable by staff" ON public.site_settings;
