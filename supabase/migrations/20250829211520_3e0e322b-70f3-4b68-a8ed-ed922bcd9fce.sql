...
-- Add CBM capacity field to containers table with default value
ALTER TABLE public.containers 
ADD COLUMN cbm_capacity NUMERIC(10,3) DEFAULT 50.0;

-- Update existing containers with proper CBM capacity based on type
UPDATE public.containers 
SET cbm_capacity = CASE 
