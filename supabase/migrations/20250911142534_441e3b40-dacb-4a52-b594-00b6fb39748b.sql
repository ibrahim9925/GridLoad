...
SELECT supabase_realtime.add_table_to_publication('supabase_realtime', 'sales');
SELECT supabase_realtime.add_table_to_publication('supabase_realtime', 'products');  
SELECT supabase_realtime.add_table_to_publication('supabase_realtime', 'stock_alerts');
...
BEGIN
  ...
  PERFORM supabase_realtime.add_table_to_publication('supabase_realtime', table_name);
  RETURN true;
EXCEPTION
  WHEN OTHERS THEN
    RETURN false;
